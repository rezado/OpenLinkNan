...
resize_pblock [get_pblocks pblock_cc] -add {SLR2:SLR3}
...
resize_pblock [get_pblocks pblock_hnf_0] -add {CLOCKREGION_X3Y7:CLOCKREGION_X6Y8}
...
resize_pblock [get_pblocks pblock_hnf_1] -add {CLOCKREGION_X3Y5:CLOCKREGION_X6Y6}
...
resize_pblock [get_pblocks pblock_hnf_2] -add {CLOCKREGION_X3Y3:CLOCKREGION_X6Y4}
...
resize_pblock [get_pblocks pblock_hnf_3] -add {CLOCKREGION_X3Y1:CLOCKREGION_X6Y2}
...
resize_pblock [get_pblocks pblock_rs_0x00] -add {CLOCKREGION_X4Y9:CLOCKREGION_X5Y9}
...
resize_pblock [get_pblocks pblock_rs_0x08] -add {CLOCKREGION_X7Y9:CLOCKREGION_X7Y9}
...
resize_pblock [get_pblocks pblock_rs_0x10] -add {CLOCKREGION_X7Y7:CLOCKREGION_X7Y7}
...
resize_pblock [get_pblocks pblock_rs_0x18] -add {CLOCKREGION_X7Y5:CLOCKREGION_X7Y5}
...
resize_pblock [get_pblocks pblock_rs_0x20] -add {CLOCKREGION_X7Y3:CLOCKREGION_X7Y3}
...
resize_pblock [get_pblocks pblock_rs_0x28] -add {CLOCKREGION_X7Y1:CLOCKREGION_X7Y1}
...
resize_pblock [get_pblocks pblock_rs_0x60] -add {CLOCKREGION_X2Y1:CLOCKREGION_X2Y1}
...
resize_pblock [get_pblocks pblock_rs_0x68] -add {CLOCKREGION_X2Y3:CLOCKREGION_X2Y3}
...
resize_pblock [get_pblocks pblock_rs_0x70] -add {CLOCKREGION_X2Y5:CLOCKREGION_X2Y5}
...
resize_pblock [get_pblocks pblock_rs_0x78] -add {CLOCKREGION_X2Y7:CLOCKREGION_X2Y7}
...
resize_pblock [get_pblocks pblock_rs_0x80] -add {CLOCKREGION_X2Y9:CLOCKREGION_X2Y9}
create_pblock pblock_dev
add_cells_to_pblock [get_pblocks pblock_dev] [get_cells -quiet [list \
...
resize_pblock [get_pblocks pblock_dev] -add {CLOCKREGION_X2Y0:CLOCKREGION_X7Y0}
